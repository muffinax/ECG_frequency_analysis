...
if not os.path.exists("C:/Users/froma/Downloads/mit-bih-arrhythmia-database-1.0.0-20260518T190848Z-3-001/mit-bih-arrhythmia-database-1.0.0/107/107.mldat"):
    raise FileNotFoundError("C:/Users/froma/Downloads/mit-bih-arrhythmia-database-1.0.0-20260518T190848Z-3-001/mit-bih-arrhythmia-database-1.0.0/107/107.mldat")

try:
    print("Start read()")
    with open("C:/Users/froma/Downloads/mit-bih-arrhythmia-database-1.0.0-20260518T190848Z-3-001/mit-bih-arrhythmia-database-1.0.0/107/107.mldat", 'rb') as f:
